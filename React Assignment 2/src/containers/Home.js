...
function Home(props) {
    ...
    return (
        <div className="carousel-demo">
            <div className="card">
                <Carousel value={products} responsiveOptions={responsiveOptions} className="custom-carousel" circular
                    autoplayInterval={3000} itemTemplate={productTemplate} header={<h5>Circular, AutoPlay, 3 Items per Page and Scroll by 1</h5>} />
            </div>

            <div className="card">
                <Carousel value={products} responsiveOptions={responsiveOptions} orientation="vertical" circular verticalViewPortHeight="900px"
                    autoplayInterval={15000} itemTemplate={productTemplate} header={<h5>Vertical</h5>} />
            </div>
        </div>
    );
}
